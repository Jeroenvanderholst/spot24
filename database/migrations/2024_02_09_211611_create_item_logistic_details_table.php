...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('item_logistic_details', function (Blueprint $table) {
            ...
            $table->decimal('base_item_net_length', 16, 4)->unsigned()->nullable();
            $table->decimal('base_item_net_width', 16, 4)->unsigned()->nullable();
            $table->decimal('base_item_net_height', 16, 4)->unsigned()->nullable();
            $table->decimal('base_item_net_diameter', 16, 4)->unsigned()->nullable();
            $table->enum('net_dimension_unit', ["CMT","DTM","KTM","MMT","MTR","FOT","INH","SMI","YRD"])->nullable();
            $table->decimal('base_item_net_weight', 16, 4)->unsigned()->nullable();
            $table->enum('net_weight_unit', ["GRM","KGM","MGM","TNE","LTN","LBR","ONZ"])->nullable();
            $table->decimal('base_item_net_volume', 16, 4)->unsigned()->nullable();
