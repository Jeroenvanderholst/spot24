...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('prices', function (Blueprint $table) {
            ...
            $table->unsignedDecimal('price_quantity', 9, 4);
            $table->boolean('price_on_request')->nullable();
            $table->unsignedDecimal('gross_list_pricec', 15, 4)->nullable();
            $table->unsignedDecimal('net_price', 15, 4)->nullable();
            $table->unsignedDecimal('recommended_retail_price', 15, 4)->nullable();
            $table->unsignedDecimal('vat', 4, 2)->nullable();
