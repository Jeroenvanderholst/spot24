...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        Schema::create('item_relations', function (Blueprint $table) {
            ...
            $table->foreign('related_supplier_item_number')->references('supplier_item_number')->on('trade_item');
            $table->char('related_supplier_item_gtin', 14)->nullable();
            $table->foreign('related_supplier_item_gtin')->references('supplier_item_gtin')->on('trade_item');
