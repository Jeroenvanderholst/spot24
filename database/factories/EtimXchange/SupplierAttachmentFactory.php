...
class SupplierAttachmentFactory extends Factory
{
     ...
     * @var string
     */
    protected $model = SupplierAttachment::class;
    ...
    public function definition(): array
    {
        return [
            ...
            'attachment_language' => '["'. str_replace("_", "-", $this->faker->locale()) .'", "'. str_replace("_", "-", $this->faker->locale()) .'", "'. str_replace("_", "-", $this->faker->locale()) .'", "'. str_replace("_", "-", $this->faker->locale()) .'"]',
            'attachment_type_specification' => '[{"Language":"en-US", "AttachmentTypeSpecification":"Some specification in US english" }]',
            'attachment_filename' => $this->faker->regexify('[A-Za-z0-9]{100}'),
            'attachment_uri' => $this->faker->regexify('[A-Za-z0-9]{255}'),
            'attachment_description' => '[{"Language":"en-US", "AttachmentTypeSpecification":"Some description in US english" }]',
